...
function CompanySetup() {
    ...
    const submitHandler=async(e)=>{
        ...
        try {
            setLoading(true)
            const res=await axios.put(`${COMPANYREGISTER_API_END_POINT}/update/${params.id}`,formData,{
                headers:{
            ...
            <div className='max-w-xl mx-auto my-10'>
                <form onSubmit={submitHandler}>
                    <div className='flex gap-5 p-8 items-center'>
                        <Button onClick={()=>navigate("/admin/company/create")} variant="outline" className="flex items-center  gap-2 text-gray-500 font-semibold">
                            <ArrowLeft />
                            <span>Back</span>
                        </Button>
